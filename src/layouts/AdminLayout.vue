...
const pathToI18nKey: Record<string, string> = {
  ...
  '/permission/http-200': 'menu.httpStatus',
  '/permission/http-202': 'menu.httpStatus',
  '/permission/http-204': 'menu.httpStatus',
  '/permission/http-300': 'menu.httpStatus',
  '/permission/http-302': 'menu.httpStatus',
  '/permission/http-400': 'menu.httpStatus',
  '/permission/http-401': 'menu.httpStatus',
  '/permission/http-402': 'menu.httpStatus',
  '/permission/http-403': 'menu.httpStatus',
  '/permission/http-404': 'menu.httpStatus',
  '/permission/http-500': 'menu.httpStatus',
  '/permission/http-501': 'menu.httpStatus',
  '/permission/http-502': 'menu.httpStatus',
  '/permission/http-503': 'menu.httpStatus',
  '/permission/http-504': 'menu.httpStatus',
  '/about': 'menu.about',
  // Charts - 25 types
